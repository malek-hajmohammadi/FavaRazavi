...
class calssName
{
    ...
    public function execute(ezcWorkflowExecution $execution, ezcWorkflowNodeAction $caller = null)
    {
        ...
        */
        ...
        {
            if($ww == 2) {$startS=700;$startE=715;} //شیفت اداری
            elseif($ww == 4) {$startS=700;$startE=715;} //شیفت مرکز
            elseif($ww == 15){$startS=700;$startE=715;} //شیفت ثابت
            elseif($ww == 12){$startS=700;$startE=715;} //شیفت مرکز2
            elseif($ww == 16){$startS=700;$startE=715;} //شیفت ثابت2
            elseif($ww == 11){$startS=800;$startE=815;} //شیفت ۸ تا ۱۷
            elseif($ww == 17){$startS=745;$startE=800;} //شیفت نعیم رضوان
            else{$startS=700;$startE=715;}
            $endS=2359;$endE=2359;

            if($wn!=4) //شنبه تا چهارشنبه
            {
                if($ww == 2) {$endS=1415;$endE=1430;} //شیفت اداری
                elseif($ww == 4) {$endS=1345;$endE=1400;} //شیفت مرکز
                elseif($ww == 15){$endS=1645;$endE=1700;} //شیفت ثابت
                elseif($ww == 12){$endS=1415;$endE=1430;} //شیفت مرکز2
                elseif($ww == 16){$endS=1645;$endE=1700;} //شیفت ثابت2
                elseif($ww == 11){$endS=1645;$endE=1700;} //شیفت ۸ تا ۱۷
                elseif($ww == 17){$endS=1450;$endE=1505;} //شیفت نعیم رضوان
                else{$endS=2359;$endE=2359;}
            }
            else //پنجشنبه
            {
                if($ww == 2) {$endS=1315;$endE=1330;} //شیفت اداری
                elseif($ww == 4) {$endS=1245;$endE=1200;} //شیفت مرکز
                elseif($ww == 15){$endS=1545;$endE=1600;} //شیفت ثابت
                elseif($ww == 12){$endS=1315;$endE=1330;} //شیفت مرکز2
                elseif($ww == 16){$endS=1545;$endE=1600;} //شیفت ثابت2
                elseif($ww == 11){$endS=1545;$endE=1600;} //شیفت ۸ تا ۱۷
                elseif($ww == 17){$endS=1450;$endE=1505;} //شیفت نعیم رضوان
                else{$endS=2359;$endE=2359;}
            }
        }
