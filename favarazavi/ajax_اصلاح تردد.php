...
//---------------------------
if (2) /*دریافت آخرین تاریخ به روزرسانی گراف*/ {
...
// ترددها
//---------------------------
if(4)/*دریافت ترددهای بین تاریخ شروع دوره تا تاریخ به روزرسانی گراف*/
{
    $client = new SoapClient('http://172.16.61.253/Timex.asmx?wsdl');
...
/////////
   /* Response::getInstance()->response = $recs3;
    return;*/
}

/// //////////
//$s3 = "EXEC [adon].[IOData_sel] ".$emp.",'1398/08/20',1398/08/25'";
if(5)/*استخراج ترددهای ناقص*/
    //در آرایه oddPassingADay//
{
    $TimexCount = 90; //فعلا
    $timexCounter = 2;
    $timeTable = array(); //ي آرايه دو بعدي از ترددهاي مرخصي ساعتي و ماموريت ساعتي
    $oddPassingADay = array();//بابت ترددهاي ناقص يا تعداد فرد در يك روز
    $counterTest = -1;
    $test = array(); //
...
//1398/08/21   2019-11-12
    ...
    /* Response::getInstance()->response = $oddPassingADay;
    return;*/

}

if (6) /*ساخت فرم برای ترددهایی که فرم در روان ندارند*/
{
//---------------------------
...
if (7) /*ساخت فرم براي ترددهاي ناقص*/
    {
