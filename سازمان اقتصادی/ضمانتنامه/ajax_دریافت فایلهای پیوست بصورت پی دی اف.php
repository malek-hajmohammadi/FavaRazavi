...
$sql = "SELECT oa_content.RealFileName,
        ...
        WHERE (oa_content.DocReferID = :did) 
                AND (oa_content.MimeType like '%image/jpeg%' OR oa_content.RealFileName LIKE '%.jpg' OR oa_content.RealFileName LIKE '%.jpeg' OR oa_content.RealFileName LIKE '%.png' OR oa_content.RealFileName LIKE '%.PNG') and  (oa_content.contentState = 1)
		  ";
