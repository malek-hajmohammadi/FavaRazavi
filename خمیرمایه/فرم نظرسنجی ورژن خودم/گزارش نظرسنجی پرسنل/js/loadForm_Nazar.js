listener = function (event) {
    ...
    class mainClass {
        ...
        runAjaxSearch() {
            this.answers = Utils.fastAjax('WorkFlowAjaxFunc', 'getAnswerOfSurvey');
        ...
        getChartDataset(partName) {
            let datasets = [];
            let data_aali = this.getDataInEachOption(partName, "aali");
            /*console.log('data_aali',data_aali);*/
            ...
            datasets.push({data: data_aali, backgroundColor: '#1976D2', label: 'عالی'});
            ...
            datasets.push({data: data_zaief, backgroundColor: '#C62828', label: 'ضعیف'});
            return datasets;
        ...
        getDataInEachOption(partName, option) {
            let startQuestion = 0;
            let endQuestion = 0;
            /*console.log('into getDataInEachOption');*/

            let optionValue = 0; /*مقدار متناظر با گزینه*/
...
/*                    console.log(item.question == question && item.answer == optionValue &&(this.userId==-1 || item.userId==this.userId));*/
        ...
        drawCharts(selector, chartData) {
            ...
            selector = '#canvas-holder-' + selector;
            /*console.log('-------------');
