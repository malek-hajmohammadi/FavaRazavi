...
class MainAjax
{
    ...
    private $backgroundCell="";
    private $backgroundCellSave="";
    private $pointerEvent="";
    private $pointerEventSave="";
    private $readOnlyForInput="";
    private $readOnlyForInputOverworkConfirm="";
    private $inputBackground="";
    private $inputBackgroundOverworkConfirm="";
    private $backgroundHeader="";
    private $cursorCell="";
    private $cursorCellSave="";
    ...
    private function getInputParameters(){
        ...
        if (Request::getInstance()->varCleanFromInput('mode'))
            $this->mode = Request::getInstance()->varCleanFromInput('mode');
        else {
    ...
    * */
        ...
        if($this->mode=="edit"){
            ...
            $this->backgroundCell="#bdbdbd";
            $this->backgroundCellSave="#bdbdbd";
            $this->pointerEvent="none";
            $this->pointerEventSave="none";
            $this->readOnlyForInput="readonly";
            $this->readOnlyForInputOverworkConfirm="readonly";
            $this->inputBackground="#e0e0e0";
            $this->inputBackgroundOverworkConfirm="#e0e0e0";
            $this->backgroundHeader="#37474f";
            $this->cursorCell="auto";
            $this->cursorCellSave="auto";
    ...
    private function getDataTableFromDatabase()
    {
        ...
        $sql = "select * FROM dm_datastoretable_36" .
            " where MasterID=$this->docId ORDER BY RowID";
