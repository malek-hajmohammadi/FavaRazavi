listener = function (event) {
    class mainClass {
        ...
        createTagQuestions() {
            ...
            for (let i = 1; i <= this.listOfQuestions.length; i++) {
                let row = " <div class=\"divTableRow\">\n" +
                    ...
                    "                            <div class=\"cntr\">\n";
                let radios = "";
                for (let j = 0; j <= 2; j++) {                     /*                     * چك كردن اينكه اين خونه پاسخ داده شده يا نه                     * و براساس آن صفت هاي اين خونه رو عوض كنه                     * */
                    let tickStateInner = "";
                    let tickStateOuter = "";
                    let option = "";
                    switch (j) {
        ...
        getAnswers() {
            this.getAnswersUsers();
            this.getAnswersModiran();
            this.getAnswersJam();
        }         /*گرفتن پاسخ ها از ديتابيس*/
    ...
    var waitInterval = setInterval(function () {
        if (FormView && FormView.myForm) {
            ...
            window.codeSet.loadForm();              /* window.codeSet.loadForm();*/
        }
