...
class MainAjax2
{
    ...
    private function getInputArguments(){
        ...
        if (Request::getInstance()->varCleanFromInput('mode'))
            $this->showMode = Request::getInstance()->varCleanFromInput('mode');
        else {
...
$mainAjax2 = new MainAjax2();
Response::getInstance()->response = $mainAjax2->makeHtml();
