    ...
    let mainFormClass = {
        ...
        showTable: function () {
            var html = Utils.fastAjax('WorkFlowAjaxFunc', 'loadListOrderRepresentation', {
                docId: FormView.docID, mode: this.DetailedTable.showMode
            });
            return html;
        },
        loadForm: function () {
            ...
            this.DetailedTable.getShowMode();
        ...
        DetailedTable:{
            ...
            updateFrontAfterRemove:function(){
                ...
                for (var i = 1; i <= lengthTable ; i++) {
                    ...
                    $jq('.detailedTable>tbody>tr.tableRow_' + i + '>td#tdDeleteImg>img').attr('onclick', 'window.codeSet.DetailedTable.removeRow(' + i + ')');
                }
            ...
            addRow:function(){
                ...
                var newTr = '<tr class="tableRow_' + (lengthTable -1) + '">' + '<td style="padding: 2px;border: 1px solid #ccc;">' + (lengthTable-1 ) + '</td>' +
                    ...
                    '<td style="padding: 2px;border: 1px solid #ccc;"><input readonly style="background: gainsboro" onInput="window.codeSet.DetailedTable.unSaved()" type="text" name="productType" value=""></td>' +
                    '<td style="padding: 2px;border: 1px solid #ccc;"><input readonly style="background: gainsboro" onInput="window.codeSet.DetailedTable.unSaved()"   dir="ltr" type="text" name="productPrice" min="0" value=""></td>' +
                    '<td style="padding: 2px;border: 1px solid #ccc;"><input onInput="window.codeSet.DetailedTable.onChangedNumberOfProductInput(this)" onkeyup=""  dir="ltr" type="number" name="productNum" min="0" value=""></td>' +
                    ...
                    '<td id="tdDeleteImg" style="padding: 2px;background-color: #c5e1a5; border: 1px solid #ccc;">' + '<img style="cursor: pointer" onclick="window.codeSet.DetailedTable.removeRow(' + (lengthTable-1) + ')"' + ' src="gfx/toolbar/cross.png" />' + '</td>' +
                    '</tr>';
            ...
            getSelectedTagForDefinedProducts:function(){
                ...
                let tag;
                tag='<td style="padding: 2px;border: 1px solid #ccc;width: 100%"><select onchange="window.codeSet.DetailedTable.onChangeSelectTag(this)" name="productName" style="width: 100%;" >';
