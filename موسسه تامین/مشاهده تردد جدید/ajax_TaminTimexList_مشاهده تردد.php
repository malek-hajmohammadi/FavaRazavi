<?php
if(1)/*گرفتن ورودی و مقداردهی اولیه*/
{
...
if(2)/*دریافت آرایه از وب سرویس*/
{
    try {
        ...
        */
        ...
        $s = "SELECT * FROM [Timex_TaminPoshtibani].[dbo].[fGetPersonInfo] ('" . $CodeM . "','" . $dt1 . "','" . $dt2 . "')";
        $param = array(
            'username' => '3ef1b48067e4f2ac9913141d77e847dd',
            'password' => '9a3f5b14f1737c15e86680d9cd40b840',
            'objStr' => $s
        ...
        $client = new SoapClient('http://10.10.100.15/WSTuralInOut/TuralInOut.asmx?wsdl');
        $s1 = "EXEC [Timex_TaminPoshtibani].[adon].[timesheetview] " . $GID . ",'" . $dt1 . "','" . $dt2 . "'";
        $param = array(
            'username' => '3ef1b48067e4f2ac9913141d77e847dd',
            'password' => '9a3f5b14f1737c15e86680d9cd40b840',
            'objStr' => $s1
