...
class calssName
{
    ...
    public function execute(ezcWorkflowExecution $execution, ezcWorkflowNodeAction $caller = null)
    {
        ...
        $KID = $PID; // شماره کارت
        $execution->workflow->myForm->setFieldValueByName('Field_1', $KID);
       ...
       // $client = new SoapClient('http://192.168.5.96/Timex.asmx?wsdl');
        ...
        $PID = $recs;
        $execution->workflow->myForm->setFieldValueByName('Field_25', $PID);
