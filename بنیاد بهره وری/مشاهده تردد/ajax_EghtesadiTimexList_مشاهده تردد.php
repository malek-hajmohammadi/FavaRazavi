...
// تاريخ و روز
    ...
    for ($j = 5; $j <= 14; $j++) {
        ...
        if ($a[0] != NULL) {
            ...
            if ($type == 'MorS') {
                //---
                $sql = "SELECT * FROM `dm_datastoretable_1390`
    left join oa_document on (oa_document.rowid = dm_datastoretable_1390.docid)
    left join oa_name_value nv1 on (nv1.parentid = dm_datastoretable_1390.docid and nv1.fieldname = 'Field_0')
    ...
    and Field_2 = '$date1'";
        ...
        <img class='f-history' onclick='History.init($ReferID)' src='gfx/toolbar/history.gif' title='نمايش سابقه فرم'></img>
                ...
                //---
                $sql = "SELECT * FROM `dm_datastoretable_1389`
    left join oa_document on (oa_document.rowid = dm_datastoretable_1389.docid)
    left join oa_name_value nv1 on (nv1.parentid = dm_datastoretable_1389.docid and nv1.fieldname = 'Field_0')
    left join oa_name_value nv2 on (nv2.parentid = nv1.rowid)
    where oa_document.isenable = 1
    and nv2.fieldname = 'uid'
    and oa_document.DocStatus = 0
    ...
    //---
    $sql = "SELECT * FROM `dm_datastoretable_1391`
    left join oa_document on (oa_document.rowid = dm_datastoretable_1391.docid)
    left join oa_name_value nv1 on (nv1.parentid = dm_datastoretable_1391.docid and nv1.fieldname = 'Field_0')
    left join oa_name_value nv2 on (nv2.parentid = nv1.rowid)
    where oa_document.isenable = 1
    and nv2.fieldname = 'uid'
    and oa_document.DocStatus = 0
    ...
    //---
    $sql = "SELECT * FROM `dm_datastoretable_1388`
    left join oa_document on (oa_document.rowid = dm_datastoretable_1388.docid)
    left join oa_name_value nv1 on (nv1.parentid = dm_datastoretable_1388.docid and nv1.fieldname = 'Field_0')
    left join oa_name_value nv2 on (nv2.parentid = nv1.rowid)
    where oa_document.isenable = 1
    and nv2.fieldname = 'uid'
    and oa_document.DocStatus = 0
    ...
    //---
    $sql = "SELECT * FROM `dm_datastoretable_1404`
    left join oa_document on (oa_document.rowid = dm_datastoretable_1404.docid)
    left join oa_name_value nv1 on (nv1.parentid = dm_datastoretable_1404.docid and nv1.fieldname = 'Field_1')
    left join oa_name_value nv2 on (nv2.parentid = nv1.rowid)
    where oa_document.isenable = 1
    and nv2.fieldname = 'uid'
    and oa_document.DocStatus = 0
