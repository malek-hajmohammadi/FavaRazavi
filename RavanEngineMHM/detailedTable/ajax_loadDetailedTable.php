<?php
/*
 *------------ لیست مراحل انجام کار----------'
* 1- تعریف یک سری ثوابت مانند رنگ جدول
* 2- گرفتن ورودی ها که اصلی کاریش docId است و mode برای داشتن حذف یا ویرایش کردن
 * mode="readOnly" or "edit" or "justDelete" or others
 * 3- تعریف استایل و هیدر جدول
 * 4- گرفتن دیتا از دیتابیس
 * 5- ساخت بدنه جدول
 * 6- دکمه های انتهایی جدول
* یک آرایه از اسم ستون های جدول
 *رنگ هیدر
 * دکمه حذف می خواهیم داشته باشد یا نه
 * شماره فرم اصلی docId
 *
 * -----------------------------------------
 *  */
