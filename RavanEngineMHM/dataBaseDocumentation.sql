...
--
-- Host: localhost
-- Generation Time: Mar 02, 2014 at 07:54 AM
...
CREATE TABLE IF NOT EXISTS `oa_content` (
  ...
  `ContentType` int(3) DEFAULT NULL COMMENT '1 scan, 2 text, 3 attach, 4 refer, 5 paraoh, 6 form field, 7 deleted fax, 8 attach for letter job, 9 OCR, 10 boardAttach, 11 perEmailAttach, 101 DMS, 201 ArchiveFileManager',
...
CREATE TABLE IF NOT EXISTS `oa_doc_refer` (
  ...
  `FaxID` bigint(20) DEFAULT NULL COMMENT '-10:ECE, -11:web service,',
...
CREATE TABLE IF NOT EXISTS `oa_maildoc` (
  ...
  `MailType` int(1) NOT NULL COMMENT ' 1=ece - 2=goverment - 3=general - 4=email - 5=EFAX - 6=FAX 7=perEmail',
